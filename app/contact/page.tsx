          ...
          <div className="text-center space-y-6">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-card-foreground">
                Contact <span className="text-primary bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent">Us</span>
              </h1>
              <div className="w-20 h-1 bg-primary rounded-full mx-auto"></div>
            </div>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Get in touch with us to discuss your project or learn more about our services. We'd love to hear from you.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <Card className="border-0 shadow-xl bg-card">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-sm font-medium text-card-foreground">Subject</label>
                  <Input 
                    id="subject" 
              ...
              <Card className="border-0 shadow-xl bg-card">
                <CardHeader className="pb-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <CardTitle className="text-2xl font-bold text-card-foreground">Business Hours</CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-primary/5 to-primary/10">
                <CardContent className="p-6">
                  <div className="text-center space-y-3">
                    ...
                    <h3 className="font-semibold text-card-foreground">Fast Response</h3>
