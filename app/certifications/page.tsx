        ...
        <FadeInSection delay={600} duration={800}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              onClick={() =>
                document
                  .getElementById('certifications-carousel')
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-6">
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
              ...
              comprehensive certification portfolio. These certifications
              validate our adherence to international standards in quality
              management, environmental responsibility, occupational health and
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <div className="flex justify-between items-center py-1.5 sm:py-2">
                    ...
                    <span className="font-semibold text-gray-900 text-sm">
                      {selectedCertification.issuingAuthority}
                    </span>
                  </div>
                </div>
