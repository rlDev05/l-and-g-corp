...
const footerLinks = {
  quickLinks: [
    ...
    { name: "Mission & Vision", href: "/#company-profile" },
    { name: "What We Offer", href: "/services" },
    { name: "Certifications", href: "#" },
  ],
  services: [
    { name: "Fuel Trading", href: "/services" },
    { name: "Gaseous Fuels", href: "/services" },
    { name: "Storage Facilities", href: "/services" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center mb-6">
                <div className="w-10 h-10 bg-[#D4A54A] rounded-lg flex items-center justify-center mr-3">
                ...
                <div>
                  ...
                  <div className="text-white font-semibold text-sm">L&G Energy Corp</div>
                </div>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-gray-200 text-sm">
                © 2025 L&G Energy Corp. All rights reserved.
              </div>
            </div>
